...
w     = 5;         % bilateral filter half-width windows size for filtering
sigma = [3 0.1];   % bilateral filter standard deviations ( [ domain range])
...
max_gradient      = 0.1;    % Edge level preservation
